        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Address = table.Column<string>(type: "varchar(1000)", maxLength: 1000, nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    BirthDate = table.Column<DateTime>(type: "datetime(6)", maxLength: 255, nullable: false),
                    ImageURL = table.Column<string>(type: "varchar(255)", maxLength: 255, nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    IsActıve = table.Column<bool>(type: "tinyint(255)", maxLength: 255, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ModifiedBy = table.Column<string>(type: "varchar(128)", maxLength: 128, nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Lenght = table.Column<double>(type: "double", nullable: true),
                    Quantity = table.Column<double>(type: "double", nullable: true),
                    QuantityUnit = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    EstWeight = table.Column<double>(type: "double", nullable: true),
                    WeightUnit = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    ExpiryDate = table.Column<DateTime>(type: "datetime(6)", nullable: true),
                    QualityGrade = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    LastBoughtPrice = table.Column<decimal>(type: "decimal(65,30)", nullable: true),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { new Guid("2809cd28-2371-4191-8a61-91527ef0f4e6"), "7513b04c-f7a5-4152-8404-5d2399fea693", "Operator", "OPERATOR" });

            migrationBuilder.InsertData(
                table: "AspNetRoles",
                columns: new[] { "Id", "ConcurrencyStamp", "Name", "NormalizedName" },
                values: new object[] { new Guid("8aa4abce-d050-4053-b3bd-2291b4d9906b"), "56feb525-905b-41e3-8f19-7cb166664b26", "Admin", "ADMIN" });
